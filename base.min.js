...
function updatePar() {
    var newText = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Hello";
...
pushButton.addEventListener('click', function () {
    ...
    try {
        for (var _iterator = (0, _getIterator3.default)(myForOfString), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
